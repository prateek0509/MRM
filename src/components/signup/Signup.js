    ...
    <div className="d-flex ">
      ...
      <div className="signup-input mx-5 px-3">
        <div className="signup-input-form text-start">
            <p><b>Welcome to Rx Laser (Prescription Rental Platform)</b></p>
            <p><b>{email}</b></p>
            <p>Your veterinarian has invited you to the platform,
Set up your account to access your prescription.</p>
