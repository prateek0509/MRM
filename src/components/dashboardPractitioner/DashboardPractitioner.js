      ...
      >
        ...
        <Modal.Body className="p-3 my-5">
          ...
          <Form>
            ...
            >
              <Form.Label className="pt-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et?</Form.Label>
              <Form.Control className="mt-4" as="textarea" rows={5} placeholder="Answer Here..."/>
            </Form.Group>
          </Form>
        </Modal.Body>
        {/* <Modal.Footer>
      ...
      <div>
        ...
        <table style={{ width: "100%" }}>
                ...
                <tbody >
                    ...
                    <td className="my-2 text-start">Lorem ipsum dolor sit amet,consectetur 
adipiscing elit, sed do eiusmod</td>
                    <td>
                      <b>
                      <button
                        className="dp-available-btn px-3 py-1 mx-2 px-3 py-1"
